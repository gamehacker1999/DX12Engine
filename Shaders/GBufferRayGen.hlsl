...
void GBufferRayGen() 
{
    ...
    GbufferPayload payload = { float4(0, 0, 0, 0), float4(0, 0, 0, 0), float3(0, 0, 0), float3(0, 0, 0) };
    ...
    ray.TMin = 0.01;
    ray.TMax = 100000;
    TraceRay(SceneBVH, RAY_FLAG_NONE, RAYTRACING_INSTANCE_OPAQUE, 0, 2, 0, ray, payload);
    ...
    gAlbedo[launchIndex] = float4(payload.albedo);
